          ...
          <div className="relative z-10">
            ...
            {!showOptions ? (
              ...
              <div className="flex flex-wrap justify-center gap-4 animate-in fade-in zoom-in duration-300">
                ...
                <a href="https://www.instagram.com/budeya.work/" target="_blank" rel="noopener noreferrer" title="Instagram" className="w-16 h-16 rounded-full bg-[#E1306C] text-white flex items-center justify-center hover:bg-[#c92b60] hover:scale-110 transition-all shadow-lg">
