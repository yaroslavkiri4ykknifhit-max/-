            ...
            <div className="flex flex-col items-center gap-6">
              {isJobSeeker ? (
                <span
                  ...
                  className="inline-flex min-h-16 items-center justify-center gap-3 bg-gray-900/50 opacity-50 cursor-not-allowed pointer-events-none text-white px-8 sm:px-10 py-5 rounded-full font-bold shadow-lg text-lg sm:text-xl select-none"
                >
              ...
              <div className="flex flex-wrap justify-center gap-4 animate-in fade-in zoom-in duration-300">
                {isJobSeeker ? (
                  <>
                    <span title="Only for recruitment agencies" className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white/40 opacity-40 cursor-not-allowed pointer-events-none text-gray-900 flex items-center justify-center shadow-lg select-none">
                      <Phone size={28} />
                    </span>
                    <span title="Only for recruitment agencies" className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white/40 opacity-40 cursor-not-allowed pointer-events-none text-gray-900 flex items-center justify-center shadow-lg select-none">
                      <Mail size={28} />
                    </span>
                    <span title="Only for recruitment agencies" className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-[#0088cc]/40 opacity-40 cursor-not-allowed pointer-events-none text-white flex items-center justify-center shadow-lg select-none">
                    ...
                    <span title="Only for recruitment agencies" className="w-16 h-16 rounded-full bg-[#07C160]/40 opacity-40 cursor-not-allowed pointer-events-none text-white flex items-center justify-center shadow-lg select-none">
                    ...
                    <span title="Only for recruitment agencies" className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gray-500/40 opacity-40 cursor-not-allowed pointer-events-none text-white flex items-center justify-center shadow-lg select-none">
