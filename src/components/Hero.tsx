        ...
        <div className="flex-1 pt-12 lg:pt-24 z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <div className="flex flex-wrap gap-4 pt-4 relative z-10 animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-300">
              ...
              <a href="https://www.instagram.com/budeya.work/" target="_blank" rel="noopener noreferrer" title="Instagram" className="w-14 h-14 rounded-full bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white flex items-center justify-center hover:scale-110 hover:shadow-pink-500/50 transition-all shadow-xl">
