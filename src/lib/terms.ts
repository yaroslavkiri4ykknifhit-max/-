...
const terms: Record<Language, TermsContent> = {
  ...
  ru: {
    ...
    lastUpdated: "Последнее обновление: 8 июля 2026",
    metaTitle: "Пользовательское соглашение | BUDEYA",
    metaDescription: "Пользовательское соглашение на поддержку легального трудоустройства в Беларуси от BUDEYA.",
    sections: [
      {
        title: "1. Информация о компании",
        body: [
          "На этом сайте представлены услуги по найму BUDEYA, предоставляемые ООО «INCOStechno» в Республике Беларусь.",
          "Адрес компании: Республика Беларусь, 220118, г. Минск, ул. Шишкина, 20/1-33.",
        ],
      },
      {
        title: "2. Использование сайта",
        body: [
          "Информация на этом сайте предоставляется для общих информационных целей о поддержке легального трудоустройства в Беларуси.",
          "Вы соглашаетесь не использовать сайт не по назначению, не вмешиваться в его работу и не предоставлять ложную, вводящую в заблуждение или незаконную информацию.",
        ],
      },
      {
        title: "3. Описание услуг",
        body: [
          "BUDEYA может предоставлять консультации, координацию документов, поддержку в получении разрешений на работу, помощь с визовыми документами, координацию переезда и поддержку связи между кандидатами, партнерскими агентствами и белорусскими работодателями.",
          "Точный объем услуг зависит от ситуации кандидата, требований работодателя и применимых миграционных и трудовых правил Республики Беларусь.",
        ],
      },
      {
        title: "4. Отсутствие гарантии получения визы или трудоустройства",
        body: [
          "BUDEYA не гарантирует, что кандидат получит предложение о работе, разрешение на работу, визу, одобрение на въезд или любое другое решение от работодателя, консульства, миграционной службы или другого государственного органа.",
          "Любое указанное время обработки, включая 30-40 дней на оформление документов, является приблизительным и может изменяться в зависимости от документов, рассмотрения работодателем, консульских процедур и государственной обработки.",
        ],
      },
      {
        title: "5. Обязанности пользователя",
        body: [
          "Кандидаты и партнерские агентства несут ответственность за предоставление точных, полных и действительных документов, включая паспортные данные, резюме, информацию о квалификации и любые необходимые документы для легализации.",
          "Пользователи несут ответственность за соблюдение законов своей страны проживания, стран транзита и Республики Беларусь, а также за оплату любых личных поездок, консульских или иных расходов, если иное не оговорено в письменном виде.",
        ],
      },
      {
        title: "6. Контактная информация",
        body: [
          "По вопросам, касающимся настоящих Условий, свяжитесь с BUDEYA по электронной почте Inkostehno@gmail.com, по телефону или WhatsApp +375 44 548 08 08, или по почте по адресу компании, указанному выше.",
        ],
      },
    ],
  },
